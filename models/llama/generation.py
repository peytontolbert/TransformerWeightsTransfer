...
class Llama(nn.Module):  # Inherit from nn.Module
    ...
    def build(
        ...
        Args:
            ...
            model_parallel_size (Optional[int], optional): Removed.
        ...
        # Seed must be the same in all processes (now single process)
        torch.manual_seed(seed)

        # Disable output redirection for local_rank 0
        # if local_rank > 0:
        ...
        ckpt_path = checkpoints[0]  # Load the first checkpoint
    ...
    def text_completion_train(
        ...
        return generation_tokens, [self.tokenizer.decode(t) for t in generation_tokens]
